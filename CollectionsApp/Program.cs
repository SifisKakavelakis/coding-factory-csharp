...
namespace CollectionsApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var hasSet = new HashSet<string>() { "Hello", "World" };
            ...
            Stack<string> stack2 = new Stack<string>(["Hello", "Coding"]);

            Queue<string> queue1 = new Queue<string>(new[] { "Hello", "World" });
            Queue<string> queue2 = new Queue<string>(["Hello", "Coding"]);
        }
        ...
        public static void DoList(List<string> list)
        {
            ...
            list.Insert(1, "World");    // Inserts at index 1, sifting right all other elements
